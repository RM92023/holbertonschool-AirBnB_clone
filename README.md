...
![Esta es una imagen de ejemplo](https://dernegocios.uexternado.edu.co/wp-content/uploads/sites/2/2020/01/airbnb-3399753_1920-1.jpg)
...
These are the classes that were used for this project
...
The HBNBCommand class is a command-line interface (CLI) for the AIRBNB project. It allows users to enter commands like "create", "show", "all", "destroy", "update", and "count" followed by the necessary arguments to perform operations on the data.

The CLI displays the prompt "(hbnb)" and waits for user input. It then parses the input, executes the corresponding command, and displays the appropriate results or messages based on the executed command.

### Run Console

To be able to run the console is as follows
```
$ ./console.py
```
...
To be able to test all the test files is with the following command
```
python3 -m unittest discover tests
```

To only test a single file you put the following command
```
...
Kevin Muñoz Bneitez - https://github.com/Kevinmunoz44

Robinson Muñeton Jaramillo - https://github.com/RM92023 